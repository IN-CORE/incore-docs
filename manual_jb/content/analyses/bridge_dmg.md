...
--- | --- | --- | --- | ---
`result` <sup>*</sup> | [`ergo:bridgeDamageVer2`](https://tools.in-core.org/semantics/api/types/ergo:bridgeDamageVer2) | `bridges` | Results | A dataset containing results <br>(format: CSV).
`damage_result` <sup>*</sup> | [`incore:bridgeDamageSupplement`](https://tools.in-core.org/semantics/api/types/incore:bridgeDamageSupplement) | `bridges` | Results | Information about applied hazard value and fragility<br>(format: JSON).
