...
key name | type | name | description
--- | --- | --- | ---
`water_facilities` <sup>*</sup> | [`ergo:waterFacilityTopo`](https://tools.in-core.org/semantics/api/types/ergo:waterFacilityTopo) | Facility dataset |  A water facility dataset.
...
--- | --- | --- | --- | ---
`result` <sup>*</sup> | [`ergo:waterFacilityDamageVer5`](https://tools.in-core.org/semantics/api/types/ergo:waterFacilityDamageVer5) | `water_facilities` | Results | A dataset containing results <br>(format: CSV).
`damage_result` <sup>*</sup> | [`incore:waterFacilityDamageSupplement`](https://tools.in-core.org/semantics/api/types/incore:waterFacilityDamageSupplement) | `water_facilities` | Results | Information about applied hazard value and fragility<br>(format: JSON).
