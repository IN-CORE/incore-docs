...
--- | --- | --- | --- | ---
`result` <sup>*</sup> | [`incore:pipelineDamageVer2`](https://tools.in-core.org/semantics/api/types/incore:pipelineDamageVer2) |`pipeline` | Results | A dataset containing results <br>(format: CSV).
