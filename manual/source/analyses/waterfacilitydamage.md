...
```
    ...
    # Load input datasets, water facility inventory and dfr3 mapping
    wf_dmg.load_remote_input_dataset("pipeline", facility_dataset_id)
    wf_dmg.load_remote_input_dataset("dfr3_mapping_set", mapping_id)
