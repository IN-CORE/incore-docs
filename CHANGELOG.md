...
- Added throwaway variable for the `out_dataset` parameter returned by `CensusUtil.get_census_data` in Social Vulnerability example. [#220](https://github.com/IN-CORE/incore-docs/issues/220)
